...
def about(request):
    ...
    return render(request, 'article/about.html', {'page_obj': page_obj, 'menu': menu, 'title': 'О сайте'})
...
#     else:
#         form = AddPostForm()
#     return render(request, 'article/addpage.html', {'form': form, 'menu': menu, 'title': 'Добавление статьи'})
